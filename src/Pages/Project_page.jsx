    ...
    <>
      <div className="min-h-screen pt-[114px] px-5 max-w-[1560px] mx-auto">
        ...
        <div className="border-2 border-orange-500">
          {/* Projects */}
          <div className="text-white font-bold border-2 border-blue-500 text-[32px]">
        ...
        <div className="">
          {/* title */}
          <div className="text-white font-medium mt-[68px] border-2 border-red-500 mb-[48px] text-[32px]">
            <span className="text-[#C77BDD]">#</span>
